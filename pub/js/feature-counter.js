...
jQuery(function () {
  var $adminmenuTopItem = jQuery("#wp-admin-bar-w3tc > a"),
    ...
    $menuItem = jQuery(
      '#toplevel_page_w3tc_dashboard.wp-not-current-submenu a[href="admin.php?page=w3tc_dashboard"] .wp-menu-name',
    ),
    $submenuItem = jQuery(
      '#toplevel_page_w3tc_dashboard a[href="admin.php?page=w3tc_feature_showcase"]',
    ),
    markup =
