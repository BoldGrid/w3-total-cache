  ...
  function w3tcps_load(nocache) {
    ...
    $.getJSON(
      ajaxurl +
        ...
        w3tcGetAjaxNonce("pagespeed_widgetdata") +
        "&w3tc_action=pagespeed_widgetdata" +
        (nocache ? "&cache=no" : ""),
      function (data) {
        $(".w3tcps_loading")
          .addClass("w3tc_none")
        ...
        if (data.error) {
          $(".w3tcps_error").html(
            w3tcData.lang.pagespeed_widget_data_error + data.error,
          );
      ...
      $(".w3tcps_error").html(
        w3tcData.lang.pagespeed_widget_data_error + jqXHR.responseText,
      );
      $(".w3tcps_error").removeClass("w3tc_none");
      $(".w3tc-gps-widget").addClass("w3tc_none");
      $(".w3tcps_loading")
