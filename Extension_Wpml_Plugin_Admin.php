...
class Extension_Wpml_Plugin_Admin {
	...
	static public function w3tc_notes_wpml( $notes ) {
		...
		if ( !Util_Environment::is_w3tc_pro( $config ) )
			$activate_text = 'Available after <a class="button w3tc-gopro-button" href="' . esc_url( 'https://www.boldgrid.com/w3-total-cache/' ) . '" target="_blank">' . esc_html__( 'ppgrade', 'w3-total-cache' ) . '</a>. ';
		else {
