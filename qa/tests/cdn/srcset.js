...
describe("srcset tag urls replacement", function () {
  ...
  it("test", async () => {
    ...
    await checkSrsetReplaced(
      ...
      new RegExp(
        themeSrc +
          ...
          themeSrc +
          "smorespieGF1-424x424\\.jpg 2\\.5x," +
          themeSrc +
          "smorespieGF1-424x424\\.jpg 300w, " +
          themeSrc +
          "smorespieGF1-424x424\\.jpg 400wff f   ,  " +
          themeSrc +
          "smorespieGF1-424x424\\.jpg 560w",
      ),
      '<img id="testSrcset" ' +
        'src="' +
        imageSrc +
        'smorespieGF1-212x212.jpg" ' +
        'srcset="' +
        imageSrc +
        "smorespieGF1-212x212.jpg 1x, " +
        imageSrc +
        ...
        "smorespieGF1-424x424.jpg 400wff f   ,  " +
        imageSrc +
        'smorespieGF1-424x424.jpg 560w" alt="S’more Pie">',
      "srcset",
    );
    ...
    themeSrc = w3tc.regExpForOption(
      env.wpContentPath.replace(/\/var\/www\/wp-sandbox\/(wp\/)?/g, "") +
        "themes/my-theme/",
    );
