...
describe('', function() {
	...
	it('copy theme files', async() => {
		...
		await sys.copyPhpToPath('../../plugins/minify-no-json-script/*', `${themePath}/qa`);
		await wp.addQaBootstrap(adminPage, `${themePath}/functions.php`, '/qa/minify-json-script-sc.php');
	});
