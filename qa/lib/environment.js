...
exports.blogWpContentUrl =
  exports.scheme +
  "://" +
  exports.blogHost +
  exports.wpMaybeColonPort +
  exports.blogWpContentUri;
exports.blogPluginsUri = blogPluginsUri();
exports.blogPluginsUrl =
  exports.scheme +
  "://" +
  exports.blogHost +
  exports.wpMaybeColonPort +
  exports.blogPluginsUri;
exports.wpUrl =
  exports.scheme +
  "://" +
  process.env["W3D_WP_HOST"] +
  exports.wpMaybeColonPort +
  exports.wpSiteUri;
...
exports.cdnFtpExportHostPort =
  "for-tests.sandbox" +
  (exports.scheme == "http" && exports.httpServerPort != 80
    ? ":" + exports.httpServerPort
    : "") +
  (exports.scheme == "https" && exports.httpServerPort != 443
    ? ":" + exports.httpServerPort
    : "");
...
function blogWpContentUri() {
  ...
  else blogWpContentPostfixUri = wpContentUri;
...
function blogPluginsUri() {
  ...
  else blogPluginsPostfixUri = pluginsUri;
