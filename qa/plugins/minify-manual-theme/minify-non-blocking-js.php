<?php
/**
 * File: minify-non-blocking-js.php
 *
 * Minify non-blocking js test: A Page Template for testing minify manual non-blocking javascript.
 *
 * Template Name: Minify: Manual: Non-blocking JS
...
wp_enqueue_script( 'minify-js1', get_template_directory_uri() . '/qa/minify-js1.js', array(), W3TC_VERSION, false );
wp_enqueue_script( 'minify-js2', get_template_directory_uri() . '/qa/minify-js2.js', array(), W3TC_VERSION, false );
wp_enqueue_script( 'minify-js3', get_template_directory_uri() . '/qa/minify-non-blocking-js3.js', array(), W3TC_VERSION, false );
