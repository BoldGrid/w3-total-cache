 ...
 * File: minify-js.php
 *
 * Minify minify manual theme test: A Page Template for testing minify manual js split.
 *
 * Template Name: Minify: Manual: JS
...
wp_enqueue_script( 'minify-js3', get_template_directory_uri() . '/qa/minify-js3.js', array(), W3TC_VERSION, false );
