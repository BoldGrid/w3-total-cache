 ...
 * File: start-end.php
 *
 * Fragment cache: Start to end.
 *
 * Template Name: Fragment cache: Start to end
 * Template Post Type: post, page
 *
 * @package W3TC
 * @subpackage QA
 *
 * phpcs:disable WordPress.Security.NonceVerification.Recommended, WordPress.Security.ValidatedSanitizedInput, WordPress.WP.GlobalVariablesOverride.Prohibited, WordPress.PHP.DiscouragedPHPFunctions
 */
 ...
 * @return string Serialized cache value.
 */
