 ...
 *
 * Minify Auto JS Test: A Page Template for testing minify auto js split.
 *
 * Template Name: Minify: Auto: JS
...
wp_enqueue_script( 'minify-js2', $url2, array(), W3TC_VERSION, false );
