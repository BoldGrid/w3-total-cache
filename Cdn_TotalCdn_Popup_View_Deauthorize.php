 ...
 *
 * Assists to deauthorize W3TC provided CDN as an objects CDN and optionally delete the pull zone.
 *
 * @since   2.6.0
 * @package W3TC
 *
...
?>
<form class="w3tc_cdn_<?php echo esc_attr( 'totalcdn' ); ?>_form" method="post">
	...
	<div class="metabox-holder">
		...
		<p class="submit">
			<input type="button" class="w3tc_cdn_<?php echo esc_attr( 'totalcdn' ); ?>_deauthorize w3tc-button-save button-primary"
