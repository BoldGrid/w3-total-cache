...
$w3tc_css_level = $this->_config->get_string( 'minify.csstidy.options.css_level' );
?>
...
<select class="css_enabled" name="minify__csstidy__options__css_level"
	...
	<?php foreach ( $w3tc_css_levels as $w3tc__css_level ) : ?>
		<option value="<?php echo esc_attr( $w3tc__css_level ); ?>"  <?php selected( $w3tc_css_level, $w3tc__css_level ); ?>>
			<?php echo esc_html( $w3tc__css_level ); ?>
		</option>
	<?php endforeach; ?>
</select><br />
