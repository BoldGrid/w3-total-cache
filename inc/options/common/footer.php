...
<div id="w3tc-footer">
	<div id="w3tc-footer-container">
		...
		<div class="w3tc-footer-column-1">
			...
			<a class="w3tc-footer-link" href="<?php echo esc_url( 'https://www.boldgrid.com/support/w3-total-cache/' ); ?>" alt="<?php esc_attr_e( 'Support Center', 'w3-total-cache' ); ?>">
				<?php esc_html_e( 'Support Center', 'w3-total-cache' ); ?>
			</a>
			<a class="w3tc-footer-link" href="<?php echo esc_url( 'https://github.com/BoldGrid/w3-total-cache' ); ?>" alt="<?php esc_attr_e( 'GitHub', 'w3-total-cache' ); ?>">
				<?php esc_html_e( 'GitHub', 'w3-total-cache' ); ?>
			</a>
		</div>
		<div class="w3tc-footer-column-1">
			<h2><?php esc_html_e( 'Support', 'w3-total-cache' ); ?></h2>
			<a class="w3tc-footer-link" href="<?php echo esc_url( 'https://www.boldgrid.com/support/forum/w3-total-cache/' ); ?>" alt="<?php esc_attr_e( 'Forums', 'w3-total-cache' ); ?>">
				<?php esc_html_e( 'Forums', 'w3-total-cache' ); ?>
			</a>
			<a class="w3tc-footer-link" href="<?php echo esc_url( 'https://www.boldgrid.com/central/login' ); ?>" alt="<?php esc_attr_e( 'Premium Support Services', 'w3-total-cache' ); ?>">
		...
		<div class="w3tc-footer-column-2">
			...
			<div class="w3tc-footer-inner-column-50">
				...
				<a class="w3tc-footer-link" href="<?php echo esc_url( Util_UI::admin_url( 'admin.php?page=w3tc_general#stats' ) ); ?>" alt="<?php esc_attr_e( 'Caching Statistics', 'w3-total-cache' ); ?>">
		...
		<div class="w3tc-footer-column-1">
			...
			<a class="w3tc-footer-link" href="<?php echo esc_url( 'https://twitter.com/boldgrid' ); ?>" alt="<?php esc_attr_e( 'W3 Edge', 'w3-total-cache' ); ?>">
				<span class="dashicons dashicons-twitter"></span><?php esc_html_e( 'W3 Edge', 'w3-total-cache' ); ?>
			</a>
			<a class="w3tc-footer-link" href="<?php echo esc_url( 'https://twitter.com/w3edge' ); ?>" alt="<?php esc_attr_e( 'BoldGrid', 'w3-total-cache' ); ?>">
				<span class="dashicons dashicons-twitter"></span><?php esc_html_e( 'BoldGrid', 'w3-total-cache' ); ?>
			</a>
			<a class="w3tc-footer-link" href="<?php echo esc_url( 'https://www.facebook.com/boldgrid/' ); ?>" alt="<?php esc_attr_e( 'BoldGrid', 'w3-total-cache' ); ?>">
