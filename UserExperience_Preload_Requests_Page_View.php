...
$is_enabled = UserExperience_Preload_Requests_Extension::is_enabled();
...
<div class="w3tc-gopro-manual-wrap">
	...
	Util_Ui::config_item_pro(
		array(
			...
			'disabled'        => ! $is_enabled,
			'description'     => array(),
			'excerpt'         => esc_html__( 'Specify domains whose DNS should be prefetched by browsers. Include one entry per line, e.g. (https://cdn.domain.com, https://fonts.googleapis.com, https://www.google-ananlytics.com, etc.)', 'w3-total-cache' ),
	...
	Util_Ui::config_item_pro(
		array(
			...
			'disabled'        => ! $is_enabled,
			'description'     => array(),
			'excerpt'         => esc_html__( 'Specify domains that browsers should preconnect to. Include one entry per line, e.g. (https://cdn.domain.com, https://fonts.googleapis.com, https://www.google-ananlytics.com, etc.)', 'w3-total-cache' ),
			'show_learn_more' => false,
			'no_wrap'         => true,
		)
	);
	Util_Ui::config_item_pro(
		array(
			...
			'disabled'        => ! $is_enabled,
			'description'     => array(),
			'excerpt'         => esc_html__( 'Specify key CSS URLs that should be preloaded by browsers. Include one entry per line, e.g. (https://example.com/example.css, etc.)', 'w3-total-cache' ),
			'show_learn_more' => false,
			'no_wrap'         => true,
		)
	);
	Util_Ui::config_item_pro(
		array(
			...
			'disabled'        => ! $is_enabled,
			'description'     => array(),
			'excerpt'         => esc_html__( 'Specify key JavaScript URLs that should be preloaded by browsers. Include one entry per line, e.g. (https://example.com/example.js, etc.)', 'w3-total-cache' ),
			'show_learn_more' => false,
			'no_wrap'         => true,
		)
	);
	Util_Ui::config_item_pro(
		array(
			...
			'disabled'        => ! $is_enabled,
			'description'     => array(),
			'excerpt'         => esc_html__( 'Specify key Font URLs that should be preloaded by browsers. Include one entry per line, e.g. (https://example.com/example.woff, etc.)', 'w3-total-cache' ),
			'show_learn_more' => false,
			'no_wrap'         => true,
		)
	);
	Util_Ui::config_item_pro(
		array(
			...
			'disabled'        => ! $is_enabled,
			'description'     => array(),
			'excerpt'         => esc_html__( 'Specify key Image URLs that should be preloaded by browsers. Include one entry per line, e.g. (https://example.com/example.png, etc.)', 'w3-total-cache' ),
			'show_learn_more' => false,
			'no_wrap'         => true,
		)
	);
	...
	Util_Ui::config_item_pro(
		array(
			...
			'disabled'        => ! $is_enabled,
			'description'     => array(),
			'excerpt'         => esc_html__( 'Specify key Video URLs that should be preloaded by browsers. Include one entry per line, e.g. (https://example.com/example.mp4, etc.)', 'w3-total-cache' ),
			'show_learn_more' => false,
			'no_wrap'         => true,
		)
	);
	...
	Util_Ui::config_item_pro(
		array(
			...
			'disabled'        => ! $is_enabled,
			'description'     => array(),
			'excerpt'         => esc_html__( 'Specify key Audio URLs that should be preloaded by browsers. Include one entry per line, e.g. (https://example.com/example.mp3, etc.)', 'w3-total-cache' ),
			'show_learn_more' => false,
			'no_wrap'         => true,
		)
	);
	...
	Util_Ui::config_item_pro(
		array(
			...
			'disabled'        => ! $is_enabled,
			'description'     => array(),
			'excerpt'         => esc_html__( 'Specify key Document URLs that should be preloaded by browsers. Include one entry per line, e.g. (https://example.com/example.pdf, etc.)', 'w3-total-cache' ),
			'show_learn_more' => false,
			'no_wrap'         => true,
		)
	);
	...
	if ( $is_pro && ! $is_enabled ) {
		echo wp_kses(
			sprintf(
				...
				__(
					'%1$sPreload Requests%2$s is not enabled in the %3$sGeneral Settings%4$s.',
					'w3-total-cache'
				),
				'<em>',
				'</em>',
	...
	Util_Ui::pro_wrap_maybe_end( 'preload-requests', true );
	?>
</div>
<?php
