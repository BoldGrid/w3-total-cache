...
class Cdn_RackSpaceCloudFiles_Page {
	...
	public static function admin_print_scripts_w3tc_cdn() {
		wp_enqueue_script( 'w3tc_cdn_rackspace', plugins_url( 'Cdn_RackSpaceCloudFiles_Page_View.js', W3TC_FILE ), array( 'jquery', 'w3tc-nonce', 'w3tc-lightbox' ), '1.0', false );
	}
	...
	public static function w3tc_settings_cdn_boxarea_configuration() {
		...
		$api_key         = $w3tc_config->get_string( 'cdn.rscf.key' );
