...
class Generic_WidgetAccount {
	...
	public static function admin_init_w3tc_dashboard() {
		$w3tc_o = new Generic_WidgetAccount();
		add_action( 'w3tc_widget_setup', array( $w3tc_o, 'wp_dashboard_setup' ), 100 );
		add_action( 'w3tc_network_dashboard_setup', array( $w3tc_o, 'wp_dashboard_setup' ), 100 );
	}
