...
<table class="form-table">
	...
	<tr>
		...
		<td class="w3tc_config_value_text">
		<input id="w3tc_totalcdn_hostname" type="text" name="cdn__totalcdn__cdn_hostname"
			value="<?php echo esc_html( $config->get_string( 'cdn.totalcdn.cdn_hostname' ) ); ?>" size="100" />
			<p class="description">
				<?php
				echo wp_kses(
					sprintf(
