...
= 2.4.0 =
* Feature: User Interface: Overhaul for better in-plugin navigation and appearance
* Feature: Object Cache: Added w3tc_config_item_objectcache.enabled filter to disable Object Cache
* Update: Setup Guide: Added tab for Image Service feature and info block in final tab for Google PageSpeed tool
