...
<p><?php esc_html_e( 'Shopping around for better hosting? Checkout our', 'w3-total-cache' ); ?> <a href="<?php echo esc_url( 'https://www.boldgrid.com/wordpress-hosting/?utm_source=w3tc&utm_medium=partners_widget&utm_campaign=hosting_partners' ); ?>" target="_blank"><?php esc_html_e( 'WordPress Hosting Recommendations', 'w3-total-cache' ); ?></a></p>
<hr>
