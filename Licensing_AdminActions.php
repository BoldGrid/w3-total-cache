...
class Licensing_AdminActions {
	 ...
	 *
	 * @param string $w3tc_name The name of the parameter to retrieve.
	 *
	...
	public function w3tc_licensing_reset_rooturi() {
		...
		Licensing_Core::activate_license( $w3tc_license_key, W3TC_VERSION );
		...
		$w3tc_r = Licensing_Core::reset_rooturi( $this->_config->get_string( 'plugin.license_key' ), W3TC_VERSION );

		if ( isset( $w3tc_r->status ) && 'done' === $w3tc_r->status ) {
			Util_Admin::redirect_with_custom_messages2(
				array(
