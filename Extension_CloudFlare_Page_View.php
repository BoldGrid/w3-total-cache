...
<form action="admin.php?page=w3tc_extensions&amp;extension=cloudflare&amp;action=view" method="post">
	...
	<div class="metabox-holder">
		...
		<div>
				<h3> <a style="text-decoration:none" href="<?php esc_url( Util_UI::admin_url( 'admin.php?page=w3tc_general' ) ); ?>" target="_blank"> <?php esc_html_e( 'Click here', 'w3-total-cache' ); ?> </a> <?php esc_html_e( 'for the general settings for Cloudflare ', 'w3-total-cache' ); ?> </h3>
		</div>
