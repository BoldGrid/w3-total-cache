...
?>
<p>
	<?php esc_html_e( 'Google Page Speed API is not available.', 'w3-total-cache' ); ?>
</p>
<p>
	<?php
	echo wp_kses(
		sprintf(
			...
			__(
				'Please follow the directions found in the Google Page Speed settings box on the %1$sGeneral Settings%2$s tab.',
				'w3-total-cache'
			),
