 ...
 * @param string  $w3tc_origin_url          Origin URL or IP.
 * @param string  $w3tc_name                Pull zone name.
 * @param string  $w3tc_cdn_hostname        CDN hostname.
...
$w3tc_is_same_zone = $cdn_pull_zone_id === $cdnfsd_pull_zone_id;
	...
	<div class="metabox-holder">
		...
		<table class="form-table">
			<tr>
				...
				<td><?php echo \esc_html( $w3tc_name ); ?></td>
			</tr>
			<tr>
				<td><?php \esc_html_e( 'Origin URL / IP', 'w3-total-cache' ); ?>:</td>
				<td><?php echo \esc_html( $w3tc_origin_url ); ?></td>
			</tr>
			<tr>
				<td><?php \esc_html_e( 'CDN hostname', 'w3-total-cache' ); ?>:</td>
				<td><?php echo \esc_html( $w3tc_cdn_hostname ); ?></td>
			</tr>
			<tr>
