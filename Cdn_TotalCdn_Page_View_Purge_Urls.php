<?php
/**
 * File: Cdn_TotalCdn_Page_View_Purge_Urls.php
 *
 * Total CDN settings purge URLs view.
 *
 * @since   2.6.0
 * @package W3TC
 *
...
<table class="form-table">
	<tr>
		...
		<td>
				<textarea id="w3tc-cdn-totalcdn-purge-urls" class="w3tc-ignore-change" cols="60" rows="5"
				...
				<p>
					<input id="w3tc-cdn-totalcdn-purge-urls-button" class="button-primary" type="button"
