		...
		return array(
			'opportunities' => array(
				...
				'server-response-time'         => array(
					'instructions' => '<p>' . esc_html__( 'W3 Total Cache Page Caching (fastest module)', 'w3-total-cache' ) . '</p>',
				),
				'redirects'                    => array(
					'instructions' => '<p>' . esc_html__( 'When dealing with server-side redirects, we recommend that they be executed via web server configuration as they are often faster than application-level configuration.', 'w3-total-cache' ) . '</p>
				...
				'dom-size'                     => array(
					'instructions' => '<p>' . esc_html__( 'Without completely redesigning your web page from scratch, typically you cannot resolve this warning. Understand that this warning is significant and if you get it for more than one or two pages in your site, you should consider:', 'w3-total-cache' ) . '</p>
						<ol>
				...
				'unsized-images'               => array(
					'instructions' => '<p>' . esc_html__( 'To fix this audit, simply specify, both, the width and height for your webpage\'s image and video elements. This ensures that the correct spacing is used for images and videos.', 'w3-total-cache' ) . '</p>
						<p>' . esc_html__( 'For example:', 'w3-total-cache' ) . '</p>
			...
			'diagnostics'   => array(
				...
				'first-contentful-paint-3g'        => array(
					'instructions' => '<p>' . esc_html__( 'Enable Page Cache using the fastest engine.', 'w3-total-cache' ) . '</p>
				...
				'uses-long-cache-ttl'              => array(
					'instructions' => '<p>' . esc_html__( 'Use Browser Caching in W3 Total Cache and set the Expires header and cache control header for static files and HTML.', 'w3-total-cache' ) . '</p>
				...
				'resource-summary'                 => array(
					'instructions' => '<p>Actions that can help:</p>
						<ul>
				...
				'largest-contentful-paint-element' => array(
					'instructions' => '<p>' . esc_html__( 'How To Fix Poor LCP', 'w3-total-cache' ) . '</p>
						<br/>
