	...
	public static function get_pagespeed_instructions() {
		return array(
			'opportunities' => array(
				...
				',
				'offscreen-images'             => '
					<p>' . esc_html__( 'Enable lazy load for images.', 'w3-total-cache' ) . '</p>
				',
				'uses-optimized-images'        => '
					<p>' . esc_html__( 'Use W3TC Image Service to convert images to WebP.', 'w3-total-cache' ) . '</p>
				',
				'modern-image-formats'         => '
					<p>' . esc_html__( 'Use W3TC Image Service to convert images to WebP.', 'w3-total-cache' ) . '</p>
				',
				'uses-text-compression'        => '
					<p>' . esc_html__( 'Use W3 Total Cache Browser Caching - Peformance>Browser Cache - Enable Gzip compression or Brotli compression (Gzip compression is most common anf for Brotli compression you need to install ', 'w3-total-cache' ) . '<a href="' . esc_url( 'https://github.com/kjdev/php-ext-brotli' ) . '" target="_blank">' . esc_html__( 'Brotli extension', 'w3-total-cache' ) . '</a>' . esc_html__( ' on your server.', 'w3-total-cache' ) . '</p>
				',
				'uses-rel-preconnect'          => '
				...
				'server-response-time'         => '
					<p>' . esc_html__( 'W3 Total Cache Page Caching (fastest module)', 'w3-total-cache' ) . '</p>
				',
				'redirects'                    => '
				...
				',
				'uses-rel-preload'             => '
					<p>' . esc_html__( 'JS and CSS - Use HTTP2/Push for W3TC Minified files', 'w3-total-cache' ) . '</p>
				...
				',
				'total-byte-weight'            => '
					<p>' . esc_html__( 'Deffer or async the JS (Select  Non blocking using Defer or  Non blocking using async Embed method in W3 Total Cache Minify options before head and after body)', 'w3-total-cache' ) . '</p>
				...
				',
				'user-timings'                 => '
					<p>' . esc_html__( 'The ', 'w3-total-cache' ) . '<a href="' . esc_url( 'https://developer.mozilla.org/docs/Web/API/User_Timing_API' ) . '" target="_blank">' . esc_html__( 'User Timing API', 'w3-total-cache' ) . '</a>' . esc_html__( ' gives you a way to measure your app\'s JavaScript performance.', 'w3-total-cache' ) . '</p>
				...
				',
				'third-party-facades'          => '
					<p>' . esc_html__( 'Preload - Lazyload embeded videos.', 'w3-total-cache' ) . '</p>
				',
				'lcp-lazy-loaded'              => '
				...
				'non-composited-animations'    => '
					<p><a href="' . esc_url( 'https://developers.google.com/web/fundamentals/performance/rendering/stick-to-compositor-only-properties-and-manage-layer-count' ) . '" target="_blank">' . esc_html__( 'Only using compositor properties:', 'w3-total-cache' ) . '</a></p>
			...
			'diagnostics'   => array(
				...
				',
				'uses-long-cache-ttl'              => '
					<p>' . esc_html__( 'Use Browser Caching in W3 Total Cache and set the Expires header and cache control header for static files and HTML.', 'w3-total-cache' ) . '</p>
					<p>' . esc_html__( 'Use default values for best results', 'w3-total-cache' ) . '</p>
				',
				'critical-request-chains'          => '
					<p>' . esc_html__( 'Eliminate Render Blocking CSS and apply asynchronous loading where applicable. Additionally, image optimization by way of resizing, lazy loaidng, and webp conversion can impact this metric as well.', 'w3-total-cache' ) . '</p>
				',
				'resource-summary'                 => '
