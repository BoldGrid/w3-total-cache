...
<?php if ( ! $authorized ) : ?>
	<tr>
		...
		<td>
			...
			<p>
				<?php esc_html_e( 'Enhance your website Performance with StackPath\'s CDN services. StackPath works magically with W3 Total Cache to speed up your site around the world for as little as $27.50 a month.', 'w3-total-cache' ); ?>
			</p>
			<p>
