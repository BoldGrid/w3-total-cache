	...
	public function config_labels( $config_labels ) {
		return array_merge(
			...
			array(
				...
				'minify.js.http2push'                                  => __( '<acronym title="Hypertext Transfer Protocol">HTTP</acronym>/2 push', 'w3-total-cache' ),
				...
				'minify.css.http2push'                                 => __( '<acronym title="Hypertext Transfer Protocol">HTTP</acronym>/2 push', 'w3-total-cache' ),
